        ...
        <div className="gerentePerfilUserMenu">
          ...
          {menuOpen && (
            <div className="gerentePerfilMenuDropdown">
              <button className="gerentePerfilMenuItem" onClick={() => navigate("/perfil-cliente")}>
                Perfil
              </button>
              <button className="gerentePerfilMenuItem" onClick={() => navigate("/configuracion-cliente")}>
                Configuración
              </button>
              <button className="gerentePerfilMenuItem" onClick={handleLogout}>
                Cerrar Sesión
              </button>
            </div>
          )}
        ...
        <div className="gerentePerfilContentContainer">
          ...
          <div className="gerentePerfilInfo">
            ...
            <div className="gerentePerfilDetails">
              <p className="gerentePerfilDetailItem">
                <strong>Nombre:</strong> Mario Alberto Córdova Moreno
              </p>
              <p className="gerentePerfilDetailItem">
                <strong>Email:</strong> mario.cordova@example.com
              </p>
              <p className="gerentePerfilDetailItem">

        ...
        <div className="cajeroPerfilUserMenu">
          ...
          {menuVisible && (
            <div className="cajeroPerfilMenuDropdown">
              <button className="cajeroPerfilMenuItem" onClick={() => navigate("/perfil-cajero")}>Perfil</button>
              <button className="cajeroPerfilMenuItem" onClick={() => navigate("/configuracion-cajero")}>Configuración</button>
              <button className="cajeroPerfilMenuItem" onClick={handleLogout}>Cerrar Sesión</button>
            </div>
          )}
        </div>
      </header>
        ...
        <div className="cajeroPerfilContentContainer">
          ...
          <div className="cajeroPerfilInfo">
            ...
            <div className="cajeroPerfilDetails">
              <p className="cajeroPerfilDetailItem"><strong>Nombre:</strong> Juan Pérez</p>
              <p className="cajeroPerfilDetailItem"><strong>Email:</strong> juan.perez@example.com</p>
              <p className="cajeroPerfilDetailItem"><strong>Teléfono:</strong> +123 456 7890</p>
              <p className="cajeroPerfilDetailItem"><strong>Dirección:</strong> 123 Calle Principal, Ciudad</p>
              <p className="cajeroPerfilDetailItem"><strong>Profesión:</strong> Cajero</p>
            </div>
          </div>

        ...
        <div className="gerenteUserMenu">
          ...
          {menuVisible && (
            <div className="gerenteMenuDropdown">
              <button className="gerenteMenuItem" onClick={() => navigate("/perfil-gerente")}>
                Perfil
              </button>
              <button className="gerenteMenuItem" onClick={() => navigate("/configuracion-gerente")}>
                Configuración
              </button>
              <button className="gerenteMenuItem" onClick={handleLogout}>
                Cerrar Sesión
              </button>
            </div>
          )}

...
-- Tiempo de generación: 27-05-2025 a las 21:31:16
...
--
-- Base de datos: `agrobanco_salvadoreno`
--
CREATE DATABASE IF NOT EXISTS `agrobanco_salvadoreno` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
...
--
-- Volcado de datos para la tabla `pagos_prestamos`
--
...
--
-- Volcado de datos para la tabla `tipos_prestamo`
--
